...
export default function QuickMedApp() {
  ...
  useEffect(() => {
    selectedMedicineRef.current = selectedMedicine;
  }, [selectedMedicine]);
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setLoginPrompt(false), 3500);
  ...
  const goTo = useCallback((p, medicine) => {
    if (p !== pageRef.current) {
      setHistory((h) => [
        ...h,
        { page: pageRef.current, medicine: selectedMedicineRef.current },
      ]);
    }
  ...
  const addToCart = useCallback(
    (m, qty = 1) => {
      ...
      setCart((c) => {
        ...
        if (existing)
          return c.map((i) => (i.id === m.id ? { ...i, qty: i.qty + qty } : i));
        return [...c, { ...m, qty }];
      });
    },
    [customer],
  ...
  return (
    ...
    >
      ...
      {!isRiderRoute && (
        <div
          style={{ position: "sticky", top: 10, zIndex: 50, padding: "0 16px" }}
        >
          <nav
            style={{
              maxWidth: 1508,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Plus color="#fff" size={19} strokeWidth={2.6} />
                </div>
                <span
                  className="qm-display"
                  style={{ fontWeight: 800, fontSize: 19 }}
                >
                  Quick<span style={{ color: C.primary }}>Med</span>
                </span>
              </div>
              <div
                style={{ display: "flex", gap: 32, alignItems: "center" }}
                className="qm-nav-desktop"
              >
                {NAV_ITEMS.map((item) => (
                  <button
                    key={item.label}
                    ...
                    style={{
                      fontSize: 15,
                      fontWeight: 600,
                      color: page === item.page ? C.primary : theme.text,
                      textDecoration: "none",
                      background: "none",
                      border: "none",
                      cursor: "pointer",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                >
                  {dark ? <SunIcon size={19} /> : <Moon size={19} />}
                </button>
                ...
                {customer && (
                  <button
                    ...
                    className="qm-btn"
                    style={{
                      background: dark ? "rgba(6,182,212,0.14)" : "#ECFEFF",
                      border: "none",
                      cursor: "pointer",
                      color: C.accent,
                      position: "relative",
                ...
                {[
                  ...
                  ...(customer
                    ? [
                        ...
                        {
                          label: `Log out (${customer.name?.split(" ")[0] || "Account"})`,
                          action: "logout",
                        },
                      ]
                  ...
                  {
                    label: "Ride with us",
                    page: rider ? "riderDashboard" : "riderLogin",
                  },
                ].map((item) => (
                  <button
                    key={item.label}
      ...
      {!isRiderRoute &&
        ...
        history.length > 0 && (
          <div
            style={{ maxWidth: 1240, margin: "0 auto", padding: "20px 24px 0" }}
          >
            <button
              onClick={goBack}
              className="qm-btn"
        ...
        >
          <div style={{ maxWidth: 1320, margin: "0 auto" }}>
            ...
            >
              ...
              personal experience with Quick Med. Results and experiences may
              vary from person to person and will be unique to each individual.
              The testimonials are voluntarily provided and are not paid. The
              individual in the photo is not the individual who provided this
              testimonial.
            </p>
            ...
            >
              <div>
                ...
                <div
                  style={{ display: "flex", gap: 10, margin: "18px 0 26px" }}
                >
              ...
              <div>
                ...
                >
                  <button
                    onClick={() =>
                      goTo(rider ? "riderDashboard" : "riderLogin")
                    }
                    style={{
                      fontSize: 13.5,
                      color: C.primary,
                  ...
                  >
                    Rider careers <ExternalLink size={12} />
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    Investors <ExternalLink size={12} />
                  </a>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                >
                  ...
                  <span style={{ lineHeight: 1.2 }}>
                    <span
                      style={{ display: "block", fontSize: 9.5, opacity: 0.85 }}
                    >
                      Download on the
                    </span>
                    <span
