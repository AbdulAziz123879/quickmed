...
export function HomePage({
  ...
  const scrollToMedicines = () =>
    medicinesRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "start",
    });
      ...
      >
        ...
        <div
          style={{
            ...
            zIndex: 0,
            background: dark
              ? `radial-gradient(700px circle at 15% 10%, rgba(37,99,235,0.25), transparent), radial-gradient(600px circle at 90% 30%, rgba(6,182,212,0.18), transparent)`
              : `radial-gradient(700px circle at 15% 10%, rgba(37,99,235,0.10), transparent), radial-gradient(600px circle at 90% 20%, rgba(16,185,129,0.10), transparent)`,
          }}
        />
        <div
          style={{
        ...
        >
          <Reveal>
            ...
            >
              ...
              <br />
              delivered within{" "}
              <span style={{ color: C.primary }}>30 minutes</span>
            </h1>
            <p
              style={{
                fontSize: 17,
            ...
            >
              Search, upload a prescription, or scan a box — Quick Med connects
              you to licensed pharmacies nearby and gets medicine to your door,
            ...
            <div
              style={{
                ...
                boxShadow: "0 16px 40px -18px rgba(17,24,39,0.22)",
                maxWidth: 640,
                margin: "0 auto 28px",
              }}
            >
            ...
            <div style={{ position: "relative", height: 440 }}>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    boxShadow: "0 16px 40px -12px rgba(37,99,235,0.55)",
                  }}
                >
              ...
              <div
                style={{
                  ...
                  borderRadius: 14,
                  padding: "12px 16px",
                  boxShadow: "0 14px 32px -16px rgba(17,24,39,0.2)",
                  display: "flex",
                  alignItems: "center",
                  gap: 10,
                }}
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              >
                Built for how medicine actually gets used
              </h2>
              <p style={{ color: theme.sub, marginTop: 10, fontSize: 15.5 }}>
                From the first symptom to the delivered dose.
              </p>
            </div>
          </Reveal>
          <div
            ...
            className="qm-feature-grid"
          >
            {FEATURES.map((f, i) => (
              <Reveal key={f.title} delay={i * 60}>
                <div
                  className="qm-card-hover"
                  style={{
                    background: theme.card,
                    border: `1px solid ${theme.border}`,
                    borderRadius: 18,
                ...
                >
                  ...
                  >
                    <f.icon size={21} color={C.primary} />
                  </div>
                  <div
            ...
            {STEPS.map((s, i) => (
              <Reveal key={s.n} delay={i * 120}>
                <div style={{ position: "relative", textAlign: "center" }}>
                  ...
                  >
                    <s.icon size={26} color={C.primary} />
                  </div>
                  <div
                    className="qm-display"
                    style={{
      ...
      <section style={{ padding: "72px 24px" }}>
        ...
        >
          <Reveal>
            ...
            >
              Healthcare delivery, done with actual care
            </h2>
            <p style={{ color: theme.sub, fontSize: 15, lineHeight: 1.7 }}>
              We built Quick Med around the moments that matter most — a fever
              at midnight, a refill you forgot, a parent who needs their
              medicine now. Every partner pharmacy is licensed, every rider is
              tracked, every order is verified.
            </p>
          </Reveal>
          <div
            ...
            {WHY.map((w, i) => (
              <Reveal key={w.title} delay={i * 70}>
                ...
                >
                  ...
                  >
                    <w.icon size={18} color="#047857" />
                  </div>
                  <div
                    style={{ fontSize: 14.5, fontWeight: 700, marginBottom: 4 }}
                  >
                    {w.title}
                  </div>
                  <div
        ...
        <Reveal>
          <div
            style={{
              maxWidth: 1240,
              margin: "0 auto",
              background: `linear-gradient(120deg, ${C.primary}, #0891B2)`,
              borderRadius: 24,
              padding: "52px 32px",
              textAlign: "center",
            }}
          >
            ...
            >
              Get health tips and offers in your inbox
            </h2>
            <p
              style={{
