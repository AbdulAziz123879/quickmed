...
//             <button onClick={() => setPlaced(true)} className="qm-btn" style={{ width: "100%", marginTop: 20, background: C.primary, color: "#fff", border: "none", padding: "13px", borderRadius: 12, fontWeight: 700, fontSize: 14.5, cursor: "pointer" }}>Place order</button>
//           </div>
//         </Reveal>
//       </div>
//       </div>
