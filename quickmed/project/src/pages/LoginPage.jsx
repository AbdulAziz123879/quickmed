...
/* LoginPage.jsx
   ...
   from the same page. Rider auth now goes through the backend's
   /api/riders/login endpoint (PostgreSQL), same as the standalone
   RiderLoginPage.
*/
...
export function LoginPage({ theme, goTo, onRiderLogin }) {
            ...
            <>
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ position: "relative" }}>
                  <input type={showPw ? "text" : "password"} placeholder="Password" style={inputStyle(theme)} />
                ...
                <button onClick={() => goTo("dashboard")} className="qm-btn" style={{ background: C.primary, color: "#fff", border: "none", padding: "13px", borderRadius: 12, fontWeight: 700, fontSize: 14.5, cursor: "pointer", marginTop: 8 }}>Log in</button>
              </div>
