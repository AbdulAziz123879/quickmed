...
//    Returns only this customer's own orders, newest first. Used by the
//    customer dashboard so a logged-in customer never sees anyone else's
//    orders (unlike GET /api/orders, which returns every order and should
//    only be used by admin/store-facing screens). */
...
//   } catch (err) {
//     console.error(
//       "[quickmed-backend] /api/customers/:id/orders error:",
//       err,
//     );
